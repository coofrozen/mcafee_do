...
def ev_log_wb():
    ...
    driver.find_element_by_xpath('//span[text()="would block"]').click()
    sleep(3)
    tbody = driver.find_element_by_id("ThreatEventLogTable_dataBody")
    tr_body = tbody.find_elements_by_tag_name("tr")
    query = "INSERT INTO threat_event_log_wb(event_rec_time,pref_event_time,event_id,event_desc,event_catagory,threat_target,action,threat_type,threat_severity,threat_vector_type,threat_target_ip) VALUES ("
    count = 0
